...
class WyomingEvent_AudioChunk$Type extends MessageType<WyomingEvent_AudioChunk> {
    constructor() {
        super("hassmic.WyomingEvent.AudioChunk", [
            { no: 1, name: "rate", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 2, name: "width", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 3, name: "channels", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: WyomingEvent_AudioChunk): WyomingEvent_AudioChunk {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 rate */ 1:
                    message.rate = reader.int64().toNumber();
                    break;
                case /* int64 width */ 2:
                    message.width = reader.int64().toNumber();
                    break;
                case /* int64 channels */ 3:
                    message.channels = reader.int64().toNumber();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class WyomingEvent_Info_Satellite$Type extends MessageType<WyomingEvent_Info_Satellite> {
    constructor() {
        super("hassmic.WyomingEvent.Info.Satellite", [
            ...
            { no: 10, name: "max_active_wake_words", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 max_active_wake_words */ 10:
                    message.maxActiveWakeWords = reader.int64().toNumber();
                    break;
    ...
    internalBinaryWrite(message: WyomingEvent_Info_Satellite, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.maxActiveWakeWords !== 0)
...
class WyomingEvent_TimerStarted$Type extends MessageType<WyomingEvent_TimerStarted> {
    constructor() {
        super("hassmic.WyomingEvent.TimerStarted", [
            ...
            { no: 2, name: "total_seconds", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 3, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "start_hours", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 5, name: "start_minutes", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 6, name: "start_seconds", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 total_seconds */ 2:
                    message.totalSeconds = reader.int64().toNumber();
                    break;
                case /* string name */ 3:
                    message.name = reader.string();
                    break;
                case /* int64 start_hours */ 4:
                    message.startHours = reader.int64().toNumber();
                    break;
                case /* int64 start_minutes */ 5:
                    message.startMinutes = reader.int64().toNumber();
                    break;
                case /* int64 start_seconds */ 6:
                    message.startSeconds = reader.int64().toNumber();
                    break;
...
class WyomingEvent_TimerUpdated$Type extends MessageType<WyomingEvent_TimerUpdated> {
    constructor() {
        super("hassmic.WyomingEvent.TimerUpdated", [
            ...
            { no: 3, name: "total_seconds", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ }
        ]);
    }
